...
export default function Home() {
  ...
  return (
    <main className="min-h-screen py-8 px-4">
        ...
        <div className="animate-fade-in-up">
          ...
          <div className="max-w-2xl mx-auto mb-8 text-center">
            <div className="fortune-card p-6 mb-6">
              ...
              <div className="flex flex-wrap justify-center gap-4 text-sm">
                ...
                <span className="px-3 py-1 bg-yellow-500/20 rounded-full text-yellow-300">
                  金運タイプ診断
                </span>
          ...
          <div className="max-w-4xl mx-auto mt-12 grid md:grid-cols-3 gap-6">
            <div className="fortune-card p-6 text-center">
              ...
              <h3 className="font-bold text-lg mb-2">本格的な紫微斗数</h3>
            ...
            <div className="fortune-card p-6 text-center">
              ...
              <h3 className="font-bold text-lg mb-2">金運特化型鑑定</h3>
              <p className="text-sm text-[#A0A0C0]">
            ...
            <div className="fortune-card p-6 text-center">
              ...
              <h3 className="font-bold text-lg mb-2">PDF鑑定書</h3>
              <p className="text-sm text-[#A0A0C0]">
      ...
      {/* フッター */}
      <footer className="mt-16 text-center text-sm text-[#A0A0C0]">
